...
OUT_TRADES  = _HERE / "varanus" / "config" / "varanusv57_blind2_trades.csv"
OUT_SUMMARY = _HERE / "varanus" / "config" / "varanusv57_blind2_summary.csv"
...
def run():
    print("=" * 65)
    print("  Varanus v5.7 — Blind Test 2")
    ...
    print("\n" + "=" * 65)
    print("  BLIND TEST RESULTS — v5.7 (Blind Test 2)")
