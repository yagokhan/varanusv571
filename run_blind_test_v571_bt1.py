#!/usr/bin/env python3
"""
run_blind_test_v571_bt1.py — Varanus v5.7.1 Blind Test 1
...
Output:
  varanus/config/varanus_v571_blind1_trades.csv
  varanus/config/varanus_v571_blind1_summary.csv
"""
...
OUT_TRADES  = _HERE / "varanus" / "config" / "varanus_v571_blind1_trades.csv"
OUT_SUMMARY = _HERE / "varanus" / "config" / "varanus_v571_blind1_summary.csv"
...
def run():
    print("=" * 65)
    print("  Varanus v5.7.1 — Blind Test 1")
    ...
    print("\n" + "=" * 65)
    print("  BLIND TEST RESULTS — v5.7.1 (Blind Test 1)")
