#!/usr/bin/env python3
"""
run_blind_test_v571_bt4.py — Varanus v5.7.1 Blind Test 4
...
Output:
  varanus/config/varanus_v571_blind4_trades.csv
  varanus/config/varanus_v571_blind4_summary.csv
"""
...
OUT_TRADES  = _HERE / "varanus" / "config" / "varanus_v571_blind4_trades.csv"
OUT_SUMMARY = _HERE / "varanus" / "config" / "varanus_v571_blind4_summary.csv"

TRAIN_CUTOFF = pd.Timestamp("2025-11-01", tz="UTC")
BLIND_START  = pd.Timestamp("2026-03-01", tz="UTC")
BLIND_END    = pd.Timestamp("2026-03-11 23:59:59", tz="UTC")
...
BLIND_DAYS = pd.date_range("2026-03-01", "2026-03-11", freq="D")
...
def fetch_blind_data():
    ...
    print("[+] Fetching blind test 4 data (Mar 01–11 2026, daily files) ...")
...
def run():
    print("=" * 65)
    print("  Varanus v5.7.1 — Blind Test 4")
    print(f"  Train : Jan 2023 – Oct 2025 (full optimization region)")
    print(f"  Test  : Mar 01 2026 – Mar 11 2026 (never seen by optimizer)")
    ...
    summary = {
        "period":             "Mar 01 2026 – Mar 11 2026",
    ...
    print("\n" + "=" * 65)
    print("  BLIND TEST 4 RESULTS — v5.7.1")
    print(f"  Period : Mar 01 2026 – Mar 11 2026 (11 days)")
    print("=" * 65)
