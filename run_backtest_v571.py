#!/usr/bin/env python3
"""
run_backtest_v571.py — Varanus v5.7.1 Full Backtest
Runs 8-fold explicit-date WFV, collects all OOS trades, computes metrics.
Outputs:
  varanus/config/varanus_v571_backtest_trades.csv   — full trade log
  varanus/config/varanus_v571_backtest_summary.csv  — fold + aggregate metrics
"""
import json
import sys
...
from varanus.walk_forward import run_walk_forward, WFV_CONFIG_V51 as WFV_CONFIG_V57
run_walk_forward_v57 = run_walk_forward
...
OUT_TRADES  = _HERE / "varanus" / "config" / "varanus_v571_backtest_trades.csv"
OUT_SUMMARY = _HERE / "varanus" / "config" / "varanus_v571_backtest_summary.csv"
...
def run():
    print("=" * 65)
    print("  Varanus v5.7.1 — Full Backtest (8-Fold Explicit-Date WFV)")
    ...
    print(f"\n[+] Running 8-fold v5.7.1 walk-forward backtest ...\n")
    ...
    # ── Print report ────────────────────────────────────────────────────────
    print("\n" + "=" * 65)
    print("  BACKTEST RESULTS — v5.7.1 Anti-Overfit (8-Fold)")
    print("=" * 65)
